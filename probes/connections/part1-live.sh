...
conn_setup part1-live

conn_cell L1 live "the source's instructions are readable inside"
...
conn_cell L2 live "a write inside reaches the source -- the direction #90 reports"
tok="$(conn_source_write "$CONN_CHANNEL_FILE")"
...
conn_cell L3 live "a source change reaches the next launch"
