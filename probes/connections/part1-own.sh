...
conn_setup part1-own

conn_cell N1 own "the source is not there at all"
...
conn_cell N2 own "a write inside does not reach the source"
tok="$(conn_source_write "$CONN_CHANNEL_FILE")"
...
conn_cell N3 own "what the sandbox writes is its own, and survives the next launch"
